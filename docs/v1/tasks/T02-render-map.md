...
The tile map renders in the viewport from `scenarios/v1.json` using the V1 isometric coordinate mapping.
...
3. Editing `scenarios/v1.json` terrain tile values (0/1) changes what is passable vs blocked visually after reload.
